            ...
            <div className="accordion" id="accordionExample" >
                ...
                <div className="accordion-item">
                    ...
                    <div id="collapseThree" className="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                        <div className="accordion-body" style={{backgroundColor: props.mode==='dark'?'#15181a':'white', color: props.mode==='dark'?'white':'#15181a'}}>
                            This word counter software works in any web browsers such as Chrome, Firefox, Internet Explorer, Safari, Opera. Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatum fuga esse nemo ex, omnis impedit temporibus consectetur similique est placeat! It suits to count characters in facebook, blog, books, excel document, pdf document, essays, etc.
                        </div>
                    </div>
                </div>
            </div>
